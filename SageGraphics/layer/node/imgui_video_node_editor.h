...
public:
    ...
    void onFrame();
private:
    ImVector<Node> _nodes;
    ImVector<NodeLink> _links;
    static ImVec2 _scroll;
    static bool _isInited;
    static bool _isShowGrid; 
};
        ...
        // // Initialization
        // if (!inited) {
        //     nodes.push_back(Node(0, "MainTex", ImVec2(0, 50), 0.5f, ImColor(255, 100, 100), 1, 1));
